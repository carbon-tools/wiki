...
gulp.task('templates', () => 
  gulp.src([
    ...
    .pipe($.htmlToJs({concat: 'templates.js', global: 'window.TEMPLATES'}))
    .pipe($.iife())
...
gulp.task('scripts', () =>
    gulp.src([
      ...
      './app/bower_components/webcamjs/webcam.min.js',
...
gulp.task('pre-publish', ['pre-publish-sw'], () => {
  return gulp.src(prepFilesToPublish, {
    dot: true,
    base: 'dist/',
  })
